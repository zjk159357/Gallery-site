...
const layoutConfig = {
  ...
  mayTitle: "2026",
  marchTitle: "Jul 2026",
  februaryTitle: "May - Jun 2026",
  januaryTitle: "Apr 2026",
  winterTitle: "Mar 2026",
  summerTitle: "Jan - Feb 2026",
...
async function main() {
  ...
  const doc = {
    ...
    mayTitle: layoutConfig.mayTitle,
    marchTitle: layoutConfig.marchTitle,
    februaryTitle: layoutConfig.februaryTitle,
    januaryTitle: layoutConfig.januaryTitle,
    winterTitle: layoutConfig.winterTitle,
    summerTitle: layoutConfig.summerTitle,
